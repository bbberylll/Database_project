...
INSERT INTO `station` VALUES ('BUSAN','부산역','부산'),('CHUNC','춘천역','춘천'),('DAEGU','대구역','대구'),('DAEJE','대전역','대전'),('GWANGJ','광주역','광주'),('ICHEON','이천역','이천'),('JEONJ','전주역','전주'),('SEOUL','서울역','서울'),('SUWON','수원역','수원'),('ULSAN','울산역','울산');
...
) ENGINE=InnoDB AUTO_INCREMENT=4053 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-06-08 19:14:06
